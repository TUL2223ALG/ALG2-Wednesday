...
public class OsobySouborTextovy {
    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            try{
                ...
                System.out.println("Soubor nenalezen. Zadej soubor znova");
            }
            } while (!konecProgramu);
            System.out.println("Koncim ...");
        } catch (IOException e) {
            System.out.println("Problem se soubory");
        }
    }
    ...
    private static void pridatOsobu() throws IOException  {
        ...
        try{
            ...
            System.out.println("Osobu nebylo mozne pridat Duvod: " + e.getMessage());
        }
    }
